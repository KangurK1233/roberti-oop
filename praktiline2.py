...
Koodi funktsionaalsuse testimisel vaatasin, et bingo mängu laud on loodud ja mängijad saavad mängida.
'''
...
game = Game()
player1 = Player(name="Steven")
player2 = Player(name="Gereth")
